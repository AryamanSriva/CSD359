...
public:
    ...
    DynamicMatrixMultiplier(const string& fileA, const string& fileB) {
...
int main() {
    // Create a DynamicMatrixMultiplier object and load matrices from files
    DynamicMatrixMultiplier multiplier("matrixA.txt", "matrixB.txt");
