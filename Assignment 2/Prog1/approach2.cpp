...
public:
    ...
    CyclicMatrixMultiplier(const string& fileA, const string& fileB) {
    ...
    void multiply() {
        ...
        #pragma omp parallel // Parallel region starts
        {
            ...
            // Cyclic distribution of rows among threads
...
int main() {
    // Create a CyclicMatrixMultiplier object and load matrices from files
    CyclicMatrixMultiplier multiplier("matrixA.txt", "matrixB.txt");
